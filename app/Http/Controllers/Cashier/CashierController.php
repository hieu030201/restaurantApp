...
class CashierController extends Controller
{
    ...
    public function getTables(){
        ...
        foreach($tables as $table){
           ...
           '<button class="btn btn-primary btn-table" data-id="'.$table->id.'" data-name="'.$table->name.'">
            <image class="img-fluid" src="'.url('/images/table.png').'"/>
            <br>';
            if($table->status == "available"){
                $html .='<span class="badge badge-success">'.$table->name.'</span>';
            }else{
                // a table is not available
        ...
        foreach($menus as $menu){
            ...
            <div class="col-md-3 text-center">
               <a class="btn btn-outline-secondary btn-menu" data-id="'.$menu->id.'">
                  <img style="height: 120px;width: 100px;" class="img-fluid" src="'.url('/menu_images/'.$menu->image).'">
                  <br>
    ...
    public function orderFood(Request $request){
         ...
         //if there is no sale for the selected table, creat a new sale record
         if(!$sale){
             $user = Auth::user();
             $sale = new Sale();
             ...
             //if there is a sale on the selected table
             $sale_id = $sale->id;
         }
         ...
         $saleDetail->save();
         //update total price in the sale tables
    ...
    public function getSaleDetailsByTable($table_id){
        ...
        if($sale){
            ...
            $html .= "Not Found Any Sale Detail for the Selected Table";
        }
        return $html;
    }
    ...
    private function getSaleDetails($sale_id){
            ...
            $html .= '<div class="table-responsive-md" style="overflow-y:scroll;heigh:400px;border:1px solid #343A40">
